// Ported from the standalone ProofPilot chatbot: src/prompts/proofpilotMentor.js
// Kept verbatim to preserve the original author's prompt design. The audit
// grounding is layered on top by the integration code (see routes/chat.ts),
// not by editing this prompt.
