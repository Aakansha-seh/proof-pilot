// Ported verbatim from the standalone ProofPilot chatbot:
// src/services/domainClassifier.js (types added for TypeScript).
...
export type DomainClassification = { supported: boolean; reason: string };

export function classifyProofPilotDomain(message: string): DomainClassification {
